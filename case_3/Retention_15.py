...
# Создаем функцию, для того чтобы расчитать количество уникальных активных пользователей в n-day
def qnt_us_day(day):
    day_use = set()
    ...
    return len(day_use)
# Расчитываем n-day retention 15 дня и округляем до 5 знаков
retention_15_day = round(qnt_us_day(15)*100/qnt_us_day(0), 5)     
